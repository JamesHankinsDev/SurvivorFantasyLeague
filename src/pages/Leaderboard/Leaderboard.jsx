...
const Leaderboard = () => {
  ...
  const { cachedAllTribes: allTribes, loading } = useFantasyTribes();
                ...
                >
                  ...
                  >
                    <div className={'md:text-md text-sm text-slate-300'}>
                      ...
                      <div
                        className={
                          'md:text-5xl text-lg font-extrabold text-center'
                        }
                      >
                    ...
                    <div
                      className={'md:text-md text-sm md:p-0 p-2 text-slate-300'}
                    >
                      Total Points:
                      <div
                        className={
                          'md:text-5xl text-md font-extrabold text-center'
                        }
                      >
                        {t.totalPoints}
                      </div>
